...
export const DEFAULT_ORDER_SUMMARY = { liveRisk: 0, won: 0, lost: 0, returns: 0, markets: 0 };

export const settledStatuses = [
  MappedOrderStatus.WON,
  MappedOrderStatus.LOST,
  MappedOrderStatus.VOIDED,
