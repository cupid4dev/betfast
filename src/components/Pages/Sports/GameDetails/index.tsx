...
export default function GameDetails () {
  ...
  return <div className="p-4">
    ...
    <div className="flex">
      <Typography variant="h6" className="float-left">19:00 - Today&nbsp;</Typography>
      <Typography variant="paragraph" className="float-left">Liquidity:&nbsp;</Typography>
      <Typography variant="paragraph" className="float-left">$ 0 USDC&nbsp;</Typography>
      <Typography variant="paragraph" className="float-left">| Traded:&nbsp;</Typography>
      <Typography variant="paragraph" className="float-left">$ 0 USDC&nbsp;</Typography>
      <br/>
    </div>
    <Button variant="gradient" className="my-2">Match Winner</Button>
    <div className="flex">
     ...
     <table className="mt-4 w-full min-w-max table-auto text-left">
        ...
        <tbody>
          <tr key={1}>
            ...
            <td className="p-4 border-b border-blue-gray-50">
              <Typography variant="paragraph" className="text-right">-</Typography>
              <Typography variant="paragraph" className="text-right">- %</Typography>
            </td>
            <td className="p-4 border-b border-blue-gray-50">
              <div className="flex w-full">
                <div className="float-left w-full p-2">
                  <Button variant="gradient" className="w-full">-</Button>
                </div>
                <div className="float-left w-full p-2">
                  <Button variant="gradient" className="w-full">-</Button>
                </div>
                <div className="float-left w-full p-2">
                  <Button variant="gradient" className="w-full" color="cyan" onClick={()=>{handleOffer();}}>Offer</Button>
                </div>
              </div>
            </td>
            <td className="p-4">
              <div className="flex w-full">
                <div className="float-left w-full p-2">
                  <Button variant="gradient" className="w-full" color="deep-orange" onClick={()=>{handleOffer();}}>Offer</Button>
                </div>
                <div className="float-left w-full p-2">
                  <Button variant="gradient" className="w-full">-</Button>
                </div>
