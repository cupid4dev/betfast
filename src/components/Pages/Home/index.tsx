...
export default function HomePage() {
  return <div>
    ...
    <div className="px-4">
      <Typography variant="h6" className="flex"><GiTennisRacket className="h-5 w-5" />&nbsp;Upcoming Tennis</Typography>
      <Card className="w-full px-4 py-4">
        ...
        <Typography variant="h5" className="mg-auto" >
          <Link href="/home" className="flex">See all Upcoming Tennis&nbsp; <FaLongArrowAltRight className="mt-4px"/> </Link>
        </Typography>
      </Card>
    </div>
  </div>;
